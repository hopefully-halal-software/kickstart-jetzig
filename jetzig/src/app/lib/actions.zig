...
pub fn login(request: *jetzig.Request, payload: *jetzig.Data.Value) !jetzig.View {
    ...
    const user = payload.get("user") orelse return libs.errors.render(request, .internal_server_error, .something_went_wrong, null);
...
pub fn register(request: *jetzig.Request, payload: *jetzig.Data.Value) !jetzig.View {
    ...
    // insert user
    {
        const name = user.getT(.string, "name") orelse return libs.errors.render(request, .internal_server_error, .something_went_wrong, null);
        const email = user.getT(.string, "email") orelse return libs.errors.render(request, .internal_server_error, .something_went_wrong, null);
        const password = user.getT(.string, "password") orelse return libs.errors.render(request, .internal_server_error, .something_went_wrong, null);
...
pub fn recover_account(request: *jetzig.Request, payload: *jetzig.Data.Value) !jetzig.View {
    // set password
    {
        ...
        const email = payload.getT(.string, "email") orelse return libs.errors.render(request, .internal_server_error, .something_went_wrong, null);
        const password = payload.getT(.string, "password") orelse return libs.errors.render(request, .internal_server_error, .something_went_wrong, null);
